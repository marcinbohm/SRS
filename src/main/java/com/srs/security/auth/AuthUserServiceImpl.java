...
import com.srs.security.domain.LoginType;
import com.srs.security.domain.RefreshToken;
import com.srs.security.jwt.BearerType;
import com.srs.security.jwt.JwtService;
import com.srs.security.jwt.TokenSubject;
...
public class AuthUserServiceImpl implements AuthService {
    ...
    public AuthSession login(String userName, String password) {
        ...
        try {
            ...
            AuthSession authSession = generateAuthSession(currentUser.getId());

            currentUser.setJwtToken(authSession.getAccessToken());
    ...
    protected AuthSession generateAuthSession(Integer userId) {
        ...
        Duration durationToken = Duration.ofMinutes(30);
        ...
        Duration durationRefreshToken = Duration.ofMinutes(200);
